...
path = "//mmfs1//projects//changhui.yan//noreen.f.khan//cell_dataset//PC3B_Final//PC3B//*"
print("\n\n dataset_path : ",path)
...
plt.savefig("Training_Accuracy_vit.png")
...
ax.set_ylabel('Loss')
#plt.show()
plt.savefig("Training_Loss_vit.png")
...
# Parameters
batch_size = 64
target_names = ["PC3_10kD1","PC3_10kD2","PC3_10kD3","PC3_20kD1","PC3_20kD2","PC3_20kD3","PC3_40kD1","PC3_40kD2", "PC3_40kD3"]
